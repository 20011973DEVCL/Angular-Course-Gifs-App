...
export class Convert {
  public static toSearchGifsResponce(json: string): SearchGifsResponce {
      return cast(JSON.parse(json), r("SearchGifsResponce"));
  }

  public static searchGifsResponceToJson(value: SearchGifsResponce): string {
      return JSON.stringify(uncast(value, r("SearchGifsResponce")), null, 2);
  }
}
